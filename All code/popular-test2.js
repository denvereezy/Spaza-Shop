...
describe("Find data in file", function(){
    ...
    it('should return all products as they are in the csv file', function(done){
     ...
     it('should return leastPopular item', function(){
        var Products = require("./productsSold");
        //var products = new Products('./Nelisa Sales History.csv');
        var productMap = {
        'Milk 1l': 142,
        ...
        assert.equal('Rose (plastic)', leastPopularProduct["Product"]);
        assert.equal(14, leastPopularProduct["Amount"]);
    });
     ...
     it('should return leastPopular item', function(){
        ...
        'Canned Food': 278,
        'Toiletries': 76,
        'Starch Food (Iwisa Pap 5kg)': 47,
        'Bakery (Bread)': 130,
        'Sweets': 192,
        'Fruit': 228,
        'Extras (Rose (plastic), Valentine Cards)': 28,
